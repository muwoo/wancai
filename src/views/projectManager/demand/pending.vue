<template>
  <div id="projectManagerdemandPending">
    <el-table
      :data="demands"
      :border='true'
      v-loading="loading"
      ...
      <el-table-column
        ...
        <template scope="scope">
          ...
          <el-button
            size="small"
            @click="handleDemandSet(scope.$index, scope.row)">修改</el-button>
          <el-button
            size="small"
            @click="handleDemandCancled(scope.$index, scope.row)">取消申请</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  ...
  export default {
    name: 'projectManagerdemandPending',
    data() {
      return {
        loading: false,
        demands: [],
