<template>
  <div id="managerDemandApplyAgain">
    <!-- 需求表表单 -->
...
export default {
  ...
  mounted() {
    ...
    this.$http(`${this.$managerURL}/demand/detail?id=${this.$route.params.id}`).then((response) => {
      const originDemandInfo = response.data.data;
      this.demandInfo.title = originDemandInfo.title;
      this.demandInfo.type = originDemandInfo.type;
      this.demandInfo.job = originDemandInfo.job;
      this.demandInfo.applyReason = originDemandInfo.applyReason;
      this.demandInfo.sex = originDemandInfo.sex;
      this.demandInfo.minAge = originDemandInfo.minAge;
      this.demandInfo.maxAge = originDemandInfo.maxAge;
      this.demandInfo.education = originDemandInfo.education;
      this.demandInfo.profession = originDemandInfo.profession;
      this.demandInfo.isMarry = originDemandInfo.isMarry;
      this.demandInfo.workExperience = originDemandInfo.workExperience;
      this.demandInfo.request = originDemandInfo.request;
      if (originDemandInfo.type === 0) {
        ...
        this.demandInfo.salary = originDemandInfo.salary;
        this.demandInfo.settlementType = originDemandInfo.settlementType;
        this.demandInfo.applyNumber = originDemandInfo.applyNumber;
