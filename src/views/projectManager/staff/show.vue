<template>
  <div id="managerUserShow">
    <div>
      <el-button type="primary" v-if="isEditInfo" @click="handleEdit">编 辑</el-button>
    ...
    <!-- <el-dialog title="修改信息" v-model="isEditDialogVisible">
      <div style="height: 440px; overflow-y: scroll;">
        <el-form :model="employInfo" label-width="130px" :rules="employInfoRules" ref="managerUserShowInfo">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 编辑
      handleEdit() {
        this.$router.push({ name: 'managerUserEdit', params: { id: this.$route.params.id } });
      },
      // 保存
      handleSave() {
