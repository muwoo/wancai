<template>
	<div id="itemList">
		...
		<el-table :data="projects" :border='true' v-loading="loading" style="width: 100%;">
			<el-table-column prop="id" label="ID" width="100" align="center">
			</el-table-column>
			<el-table-column prop="title" label="项目名称" align="center" :show-overflow-tooltip="true">
			</el-table-column>
			<el-table-column prop="managerName" label="项目经理" width="100" align="center">
			</el-table-column>
			<el-table-column prop="recruitFrontsName" label="招聘前台" width="100" align="center">
			</el-table-column>
			<el-table-column prop="createdTime" :formatter="formatDate" label="创建时间" width="200" align="center">
			</el-table-column>
			<el-table-column label="操作" align="center" width="200">
				<template scope="scope">
					<el-button size="small" @click="handleSetProjectManager(scope.$index, scope.row)">设置</el-button>
					<el-button size="small" @click="handleProjectManagerDetail(scope.$index, scope.row)">详情</el-button>
				</template>
			</el-table-column>
		</el-table>
