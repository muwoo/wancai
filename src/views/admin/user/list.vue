<template>
	<div id="userList">
		...
		<el-table :data="users" :border='true' v-loading="loading" style="width: 100%;">
			<el-table-column prop="idCard" label="身份证号" align="center" width="200">
			</el-table-column>
			<el-table-column prop="name" align="center" label="姓名">
			</el-table-column>
			<el-table-column prop="sex" :formatter="formatSex" align="center" label="性别">
			</el-table-column>
			<el-table-column prop="telphone" align="center" label="手机号" width="200">
			</el-table-column>
			<el-table-column prop="createdAt" :formatter="formatDate" align="center" width="180" label="创建时间">
			</el-table-column>
			<el-table-column label="操作" align="center" width="200">
				<template scope="scope">
					<el-button size="small" @click="handleSetBlack(scope.$index, scope.row)">拉黑</el-button>
					<el-button size="small" type="danger" @click="handleUserDetail(scope.$index, scope.row)">详情</el-button>
				</template>
			</el-table-column>
		</el-table>
