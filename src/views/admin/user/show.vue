  ...
  <div id="adminUserShow">
    ...
    <!-- <el-dialog title="修改信息" v-model="isEditDialogVisible">
      <div style="height: 440px; overflow-y: scroll;">
        <el-form :model="employInfo" label-width="130px" :rules="employInfoRules" ref="adminUserShowInfo">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 编辑
      handleEdit() {
        this.$router.push({ name: 'adminUserEdit', params: { id: this.$route.params.id } });
      },
      // 保存
      handleSave() {
